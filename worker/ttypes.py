...
class Request(object):
    ...
    def __init__(self, arguments=None, payload=None, context=None,):
    ...
    def write(self, oprot):
        ...
        if self.arguments is not None:
            oprot.writeFieldBegin('arguments', TType.MAP, 1)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.arguments))
            for kiter16, viter17 in self.arguments.items():
...
class Context(object):
    ...
    def __init__(self, operationId=None, baseUrl=None, app=None, user=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I64:
                    self.operationId = iprot.readI64()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.operationId is not None:
            oprot.writeFieldBegin('operationId', TType.I64, 1)
            oprot.writeI64(self.operationId)
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i37 in range(_size33):
                        ...
                        self.parameters.append(_elem38)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class Response(object):
    ...
    def write(self, oprot):
        ...
        if self.headers is not None:
            ...
            for kiter62, viter63 in self.headers.items():
...
Request.thrift_spec = (
    None,  # 0
    (1, TType.MAP, 'arguments', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 1
    (2, TType.STRING, 'payload', 'UTF8', None, ),  # 2
    (3, TType.STRUCT, 'context', [RequestContext, None], None, ),  # 3
)
...
Context.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'operationId', None, None, ),  # 1
